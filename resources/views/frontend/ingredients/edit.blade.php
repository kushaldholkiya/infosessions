    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.ingredients.update", [$ingredient->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.ingredient.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $ingredient->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $ingredient->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="producer" id="producer" value="{{ old('producer', $ingredient->producer) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="origin" id="origin" value="{{ old('origin', $ingredient->origin) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="allergence" id="allergence" value="{{ old('allergence', $ingredient->allergence) }}">

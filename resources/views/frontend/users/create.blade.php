                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eme_contact_person" id="eme_contact_person" value="{{ old('eme_contact_person', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eme_contact_number" id="eme_contact_number" value="{{ old('eme_contact_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="occupation" id="occupation" value="{{ old('occupation', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="process_number" id="process_number" value="{{ old('process_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="national_number" id="national_number" value="{{ old('national_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="health_number" id="health_number" value="{{ old('health_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="other_information" id="other_information">{{ old('other_information') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="favourite_food" id="favourite_food" value="{{ old('favourite_food', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="disliked_food" id="disliked_food" value="{{ old('disliked_food', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="diseases" id="diseases">{{ old('diseases') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="medication" id="medication">{{ old('medication') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="personal_history" id="personal_history">{{ old('personal_history') }}</textarea>

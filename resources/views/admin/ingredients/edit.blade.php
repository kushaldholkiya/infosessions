    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ingredients.update", [$ingredient->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('producer') ? 'is-invalid' : '' }}" type="text" name="producer" id="producer" value="{{ old('producer', $ingredient->producer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('origin') ? 'is-invalid' : '' }}" type="text" name="origin" id="origin" value="{{ old('origin', $ingredient->origin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allergence') ? 'is-invalid' : '' }}" type="text" name="allergence" id="allergence" value="{{ old('allergence', $ingredient->allergence) }}">

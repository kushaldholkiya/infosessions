    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-ingredientsArticles">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.article.fields.nutrition') }}
                            </th>
                            <th>
                                {{ trans('cruds.nutritionMaster.fields.unit') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($articles as $key => $article)
                            <tr data-entry-id="{{ $article->id }}">
                                ...
                                <td>
                                    {{ $article->nutrition->name ?? '' }}
                                </td>
                                <td>
                                    {{ $article->nutrition->unit ?? '' }}
                                </td>
                                <td>
                                    @can('article_show')
...
@endcan
  ...
  let table = $('.datatable-ingredientsArticles:not(.ajaxTable)').DataTable({ buttons: dtButtons })

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('maritial_status') ? 'is-invalid' : '' }}" name="maritial_status" id="maritial_status">
                    ...
                    @foreach(App\Models\User::MARITIAL_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('maritial_status', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eme_contact_person') ? 'is-invalid' : '' }}" type="text" name="eme_contact_person" id="eme_contact_person" value="{{ old('eme_contact_person', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eme_contact_number') ? 'is-invalid' : '' }}" type="text" name="eme_contact_number" id="eme_contact_number" value="{{ old('eme_contact_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('process_number') ? 'is-invalid' : '' }}" type="text" name="process_number" id="process_number" value="{{ old('process_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('national_number') ? 'is-invalid' : '' }}" type="text" name="national_number" id="national_number" value="{{ old('national_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('health_number') ? 'is-invalid' : '' }}" type="text" name="health_number" id="health_number" value="{{ old('health_number', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('other_information') ? 'is-invalid' : '' }}" name="other_information" id="other_information">{{ old('other_information') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('allergies') ? 'is-invalid' : '' }}" name="allergies[]" id="allergies" multiple>
                    @foreach($allergies as $id => $allergy)
                        <option value="{{ $id }}" {{ in_array($id, old('allergies', [])) ? 'selected' : '' }}>{{ $allergy }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('diets') ? 'is-invalid' : '' }}" name="diets[]" id="diets" multiple>
                    @foreach($diets as $id => $diet)
                        <option value="{{ $id }}" {{ in_array($id, old('diets', [])) ? 'selected' : '' }}>{{ $diet }}</option>
                    @endforeach
                </select>
                @if($errors->has('diets'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('constituents') ? 'is-invalid' : '' }}" name="constituents[]" id="constituents" multiple>
                    @foreach($constituents as $id => $constituent)
                        <option value="{{ $id }}" {{ in_array($id, old('constituents', [])) ? 'selected' : '' }}>{{ $constituent }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('favourite_food') ? 'is-invalid' : '' }}" type="text" name="favourite_food" id="favourite_food" value="{{ old('favourite_food', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disliked_food') ? 'is-invalid' : '' }}" type="text" name="disliked_food" id="disliked_food" value="{{ old('disliked_food', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('diseases') ? 'is-invalid' : '' }}" name="diseases" id="diseases">{{ old('diseases') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('medication') ? 'is-invalid' : '' }}" name="medication" id="medication">{{ old('medication') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('personal_history') ? 'is-invalid' : '' }}" name="personal_history" id="personal_history">{{ old('personal_history') }}</textarea>

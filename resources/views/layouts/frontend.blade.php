                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('ingredient_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.ingredients.index') }}">
                                            {{ trans('cruds.ingredient.title') }}
                                        </a>
                                    @endcan
                                    @can('allergence_master_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.allergence-masters.index') }}">
                                            {{ trans('cruds.allergenceMaster.title') }}
                                        </a>
                                    @endcan
                                    @can('diet_master_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.diet-masters.index') }}">
                                            {{ trans('cruds.dietMaster.title') }}
                                        </a>
                                    @endcan
                                    @can('constituent_master_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.constituent-masters.index') }}">

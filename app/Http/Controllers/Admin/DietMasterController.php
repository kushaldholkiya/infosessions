...
class DietMasterController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dietMasters.index', compact('dietMasters'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dietMasters.create');
    }
    ...
    public function store(StoreDietMasterRequest $request)
    {
        ...
        return redirect()->route('admin.diet-masters.index');
    }
    ...
    public function edit(DietMaster $dietMaster)
    {
        ...
        return view('admin.dietMasters.edit', compact('dietMaster'));
    }
    ...
    public function show(DietMaster $dietMaster)
    {
        ...
        return view('admin.dietMasters.show', compact('dietMaster'));
    }

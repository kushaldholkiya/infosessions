...
class UsersApiController extends Controller
{
    public function index()
    {
        ...
        return new UserResource(User::with(['roles', 'allergies', 'tags', 'diets', 'constituents'])->get());
    }
    ...
    public function show(User $user)
    {
        ...
        return new UserResource($user->load(['roles', 'allergies', 'tags', 'diets', 'constituents']));
    }

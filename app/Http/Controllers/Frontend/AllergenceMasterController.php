...
class AllergenceMasterController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.allergenceMasters.index', compact('allergenceMasters'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.allergenceMasters.create');
    }
    ...
    public function store(StoreAllergenceMasterRequest $request)
    {
        ...
        return redirect()->route('frontend.allergence-masters.index');
    }
    ...
    public function edit(AllergenceMaster $allergenceMaster)
    {
        ...
        return view('frontend.allergenceMasters.edit', compact('allergenceMaster'));
    }
    ...
    public function show(AllergenceMaster $allergenceMaster)
    {
        ...
        return view('frontend.allergenceMasters.show', compact('allergenceMaster'));
    }

...
class UsersController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.users.index', compact('allergence_masters', 'constituent_masters', 'diet_masters', 'roles', 'tags', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('allergies', 'constituents', 'diets', 'roles', 'tags'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('allergies', 'constituents', 'diets', 'roles', 'tags', 'user'));
    }

...
class ConstituentMasterController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.constituentMasters.index', compact('constituentMasters'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.constituentMasters.create');
    }
    ...
    public function store(StoreConstituentMasterRequest $request)
    {
        ...
        return redirect()->route('frontend.constituent-masters.index');
    }
    ...
    public function edit(ConstituentMaster $constituentMaster)
    {
        ...
        return view('frontend.constituentMasters.edit', compact('constituentMaster'));
    }
    ...
    public function show(ConstituentMaster $constituentMaster)
    {
        ...
        return view('frontend.constituentMasters.show', compact('constituentMaster'));
    }

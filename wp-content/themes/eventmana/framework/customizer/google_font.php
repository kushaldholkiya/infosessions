 ...
 */
 class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control{
                ...
                <label style="margin-bottom: 10px; margin-top: 10px; display:block;">
                   ...
                   <i style="padding-bottom: 5px; display:block;"><?php echo esc_html( $this->description ); ?></i>
                    <select <?php $this->link(); ?>>
                        ...
                        <?php if( get_theme_mod('cus_custom_font','') != '' ){
                                $cus_fonts = explode(',', get_theme_mod('cus_custom_font',''));
                                foreach ($cus_fonts as $key => $value) {
                                    printf('<option value="ovatheme_%s">%s</option>', trim($value), $value) ;
                                }
                            } ?>
                        <option value="Proxima-Nova-Regular"><?php esc_html_e('Proxima-Nova-Regular', 'eventmana'); ?></option>
                        <option value="Proxima-Nova-Alt-Regular"><?php esc_html_e('Proxima-Nova-Alt-Regular', 'eventmana'); ?></option>
                        <option value="ProximaNova-Bold"> <?php esc_html_e('ProximaNova-Bold', 'eventmana'); ?></option>
                        <option value="ProximaNova-Extrabld"> <?php esc_html_e('ProximaNova-Extrabld', 'eventmana'); ?></option>
                        <?php
     ...
     * @return String
     */
    public function get_fonts( $amount = '1000' ){

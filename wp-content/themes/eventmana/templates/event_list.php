    ...
    <div class="container">
                ...
                <div class="<?php echo esc_attr($width_main_content); ?>">
                    ...
                    <?php
                        ...
                        $list_orderby = get_theme_mod('cus_list_page_orderby', 'eventmana_met_event_date');
                        $list_order = get_theme_mod('cus_list_page_order', 'DESC');
                        $cus_list_page_show_pastevent = get_theme_mod('cus_list_page_show_pastevent', 'yes');
                        
                        if( ($list_orderby == 'eventmana_met_event_date') || ($list_orderby == 'eventmana_met_event_end_date') ){

                            if($cus_list_page_show_pastevent == 'yes'){
                                $args = array(
                                    'paged' => $paged,
                                    'post_type' => 'event',
                                    'post_status' => 'publish',

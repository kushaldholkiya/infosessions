...
<div class="page-section with-sidebar sidebar-right first-section">
    <div class="container">
                ...
                <div class="<?php echo esc_attr($width_main_content); ?>">
                    ...
                    <?php
                        $event_category = trim( get_post_meta( get_the_id(), "eventmana_met_event_category", true ) );
                        ...
                        if( ($cat_orderby == 'eventmana_met_event_date') || ($cat_orderby == 'eventmana_met_event_end_date') ){
                    ...
                    <div class="listing-meta">
                         ...
                         <div class="filters">
                            ...
                            <h2 class="post-title"> 
                                <?php esc_html_e('Total ','eventmana'); echo esc_html($events->found_posts); esc_html_e(' events','eventmana'); esc_html_e(' - ', 'eventmana'); echo esc_html($event_category); esc_html_e(' category ', 'eventmana'); ?>  
                            </h2>
